...
//{
//    public class OldGrid : Control, IChildrenControl
//    {
//        public class GridChildrenCollection : ICollection<Control>
//        {
//            public GridChildrenCollection(OldGrid oldGrid)
//            {
//                _oldGrid = oldGrid;
//            }

//            private readonly OldGrid _oldGrid;
...
//            {
//                if (item.Parent != _oldGrid)
//                {
//                    item.Parent = _oldGrid;
//                    return;
//                }
//                _internal.Add(item);
//                _oldGrid.Invalidate();
...
//                {
//                    _oldGrid.ChildRemoved?.Invoke(_oldGrid, new ChildRemovedEventArgs(item));
//                }
//                _oldGrid.Invalidate();
//            }
...
//                        Math.Min(child.ActualWidth, sizes.Item1.Skip(column).Take(columnSpan).Sum()),
//                        Math.Min(child.ActualHeight, sizes.Item2.Skip(row).Take(rowSpan).Sum()))));
//            }
//        }

//        public Size MeasureBoundingBox(Control child)
//        {
